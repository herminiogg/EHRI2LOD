...
sed -i "1i\@prefix ehri_pers: <http://data.ehri-project.eu/vocabularies/ehri-pers/> ." people.ttl
...
sed -i "1i\@prefix ehri_terms: <http://data.ehri-project.eu/vocabularies/ehri-terms/> ." people.ttl
