...
SPARQL_ENDPOINT = os.getenv('SPARQL_ENDPOINT') or "http://localhost:3030/EHRI/sparql"
...
DEFAULT_BASE = os.getenv('DEFAULT_BASE') or "https://data.ehri-project.eu"
...
LOCAL_SERVER_NAME = os.getenv('LOCAL_SERVER_NAME') or "http://localhost:5000"
...
START_LOCAL_NAME = os.getenv('START_LOCAL_NAME') or "units/us-005578-irn614729"
